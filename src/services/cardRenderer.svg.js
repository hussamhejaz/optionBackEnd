...
function bodySvg({
  ...
  return `
    ...
    <text x="${leftCenterX}" y="${pnlY}" fill="${deltaColor}" font-size="32" font-weight="600" text-anchor="middle" font-family="DejaVu Sans, Arial, sans-serif">${formatPnlLineValue(pnlValue)} $  ${formatNum(pnlPct)}%</text>
